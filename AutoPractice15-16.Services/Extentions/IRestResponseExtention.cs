...
namespace AutoPractice15.Services.Extentions
{
    public static class IRestResponseExtention
    {
        ...
        {
            if (response.ResponseStatus != ResponseStatus.Completed || response.StatusCode >= System.Net.HttpStatusCode.BadRequest)
            {
